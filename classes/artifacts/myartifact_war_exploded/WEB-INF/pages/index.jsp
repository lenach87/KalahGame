...
<div class="form-group">
    <form:form action="startgame" method="post" modelAttribute="gameForm"
               class="form-horizontal" role="form" cssStyle="width: 800px; margin: 0 auto;">

    <div class="form-group">
        <label for="player1" class="col-sm-2 control-label">First name</label>
        <div class="col-sm-4">
    ...
    <div class="form-group">
        <label for="player2" class="col-sm-2 control-label">Last name</label>
        <div class="col-sm-4">
